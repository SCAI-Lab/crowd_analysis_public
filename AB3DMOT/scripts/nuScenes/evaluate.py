...
from Xinshuo_PyToolbox.xinshuo_io import fileparts
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='./results/nuScenes/???/results_val.json', help='The submission as a JSON file.')
    parser.add_argument('--output_dir', type=str, default='~/nuscenes-metrics',
                        help='Folder to store result metrics, graphs and example visualizations.')
    parser.add_argument('--eval_set', type=str, default='val',
                        help='Which dataset split to evaluate on, train, val or test.')
    parser.add_argument('--dataroot', type=str, default='./data/nuScenes/data',
