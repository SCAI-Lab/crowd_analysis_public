...
class Pipeline:
    def __init__(self, model, cfg):
        ...
        self.plotting = cfg["Evaluate"]["plotting"] 
        self.visible_2D = cfg["Evaluate"]["visible_2D"]
    ...
    def evaluate(self, model, eval_loader, tb_prefix, rm_files=True):
